...
const MySwiper = () => {
    ...
    return (
        ...
        <Swiper style={{ '--swiper-navigation-color': '#fff', '--swiper-pagination-color': '#fff' }} loop={true}
                        spaceBetween={10} navigation={true} thumbs={{ swiper: thumbsSwiper }} className={clases.swiper}>
                        <SwiperSlide className={clases.swiper_item}>
                            <img className="my" src="https://swiperjs.com/demos/images/nature-1.jpg" />
                            </SwiperSlide>
                            <SwiperSlide className={clases.swiper_item}>
                                <img
                            src="https://swiperjs.com/demos/images/nature-2.jpg" /></SwiperSlide>
                            <SwiperSlide className={clases.swiper_item}>
                                <img
                                src="https://swiperjs.com/demos/images/nature-3.jpg" /></SwiperSlide>
                                <SwiperSlide className={clases.swiper_item}>
                                    <img
                                    src="https://swiperjs.com/demos/images/nature-4.jpg" /></SwiperSlide>
                                    <SwiperSlide className={clases.swiper_item}>
                                        <img
                                        ...
                                        <SwiperSlide className={clases.swiper_item}>
                                            ...
                                            <SwiperSlide className={clases.swiper_item}>
                                                ...
                                                <SwiperSlide className={clases.swiper_item}>
                                                    <img
                                                    src="https://swiperjs.com/demos/images/nature-8.jpg" /></SwiperSlide>
                                                    <SwiperSlide className={clases.swiper_item}>
                                                        <img
